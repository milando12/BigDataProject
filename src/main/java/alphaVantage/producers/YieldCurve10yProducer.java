...
public class YieldCurve10yProducer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String apiUrl = "https://www.alphavantage.co/query?function=TREASURY_YIELD&interval=monthly&maturity=10year&apikey=" + alphaVantageApiKey;
            ...
            dataArray.forEach(dataEntry -> {
                ...
                try {
                    ...
                    ProducerRecord<String, String> record = new ProducerRecord<>("yieldCurve", messageValue);
