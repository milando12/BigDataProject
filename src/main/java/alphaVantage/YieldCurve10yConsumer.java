...
public class YieldCurve10yConsumer {
    private static final String CSV_FILE = "yieldCurveData10y.csv";
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "YieldCurveConsumerGroup");
        properties.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        Consumer<String, String> consumer = new KafkaConsumer<>(properties);

        consumer.subscribe(Collections.singletonList("yieldCurve"));
